...
function makeSlider(config) {
        ...
        var defaults = {
                url: "http://info-gamepc.blogspot.com", // Your blog URL
                numPost: 10, // Number of posts to display
                ...
                summaryLength: 0, // Length of post summary
                ...
                showNav: false, // `true` to show both next/prev navigation and navigation number, "next/prev" to show next/prev navigation only, "number" to show navigation number only, `false` to hide the navigation
                navText: {
